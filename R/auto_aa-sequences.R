...
#'    \item{name}{Name of an AA Sequence. Restricts results to those with the specified name, alias, or entity registry ID.}
#'    \item{nameIncludes}{Name substring of an AA sequence. Restricts results to those with names, aliases, or entity registry IDs that include the provided substring.}
#'    \item{aminoAcids}{String of amino acids. Restricts results to AA sequences exactly matching these amino acids (case-insensitive).}
#'    \item{folderId}{ID of a folder. Restricts results to those in the folder.}
#'    \item{mentionedIn}{Comma-separated list of entry IDs. Restricts results to AA sequences mentioned in those entries.}
